...
class Yaskawa_control():
    ...
    def system_tile(self):
        ...
        catch_list, put_list, self.count_list = mix_pack()
        ...
        for catch_input, put_input in zip(catch_list, put_list):
            ...
            while self.Pc_system:# 不可刪掉
                ...
                if self.motionnumber == 1:
                    self.catch_tile(self.motionnumber, catch_input)
                    ...
                    self.catch_tile(self.motionnumber, buffer_catch[index_buffer])
    ...
    def catch_tile(self,process,catch_input,):
        while self.Pc_system:
